...
const CodePattern = () => (
  <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="https://www.imghippo.com/i/gmq7434eJQ.png">
    <pattern
      id="pattern-circles"
      x="0"
      y="0"
...
export default function Hero() {
  return (
    <>
        ...
        <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              Expert Agentic AI. Specializing in vertical AI agents with Langgraph, Langchain, vector DB, and LLMs (OpenAI, Google, DeepSeek).
              </p>
              <div className="flex justify-center lg:justify-start space-x-4 mb-8">
                <a
                  href="https://github.com/rrizwan98"
                ...
                <a
                  href="https://www.linkedin.com/in/raza-rizwan98/"
                  className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
                ...
                <a
                  href="mailto:rrizwan1998@gmail.com"
                  className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
            ...
            >
              <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="https://i.imghippo.com/files/gmq7434eJQ.png"
                    alt="Raza Rizwan"
                    fill
                    className="object-cover"
                    priority
                    unoptimized // added to bypass Next.js image optimization
                  />
                </div>
              </div>
            </motion.div>
      ...
      <a
        href="https://wa.me/03032206662" // Replace with your WhatsApp number
